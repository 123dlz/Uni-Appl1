<template>
	<view>
		...
		<text class="btns " @tap="btns">激活VIP</text>
		</view>

       <view>
		   <text class="btns" @tap="kami">购买会员卡</text>
	   </view>
...
<script>
	...
	export default {
		...
		onLoad(){
				...
				this.kamiurl = e.app.kamiurl;
				
				})	
			},
		methods: {  
			kami(){
				console.log(this.kamiurl);
			...
			btns(){
				if(this.card.length==''){
					...
					this.showload('查询中...');
					this.GetJson(this.ip + 'card.php','POST',{
