<template>
	...
	<view style="margin-top: 20rpx;padding: 20rpx 20rpx;">
			<view class='row'  v-for='(item,index) in list' :key='index' @tap="play(item.vod.id,item.index)" >
				...
				<view style="font-size: 30rpx;font-weight:700;padding:  10rpx  20rpx;width: 400rpx;" > 
				  <text class="title" style="-webkit-line-clamp: 1;">{{item.vod.name}}</text>
				  <text class="title" style="color:hotpink;">第{{Number(item.index)}}集</text>
