			...
			<view>
				<view class="row" style="padding: 20rpx 20rpx;">
					<view style="min-width: 220rpx;">
						<image class="lbpic" :src="vod.vod_pic" mode="aspectFill"></image>
					</view>
					<view style="padding: 0 20rpx;margin-top: -5px;">
						<view class="row">
							<text
								style="background-color:hotpink;padding:6rpx 12rpx;color:#FFF;border-radius: 8rpx;font-size:28rpx">{{vod.vod_class}}</text>
							<text class="lbvodname"
								style="color:#FFF;font-weight: 700;font-size: 40rpx;padding: 0 15rpx;padding-top: -10rpx;">{{vod.vod_name}}</text>
						</view>
						<text class="lbblurb" style="color:#959595;font-size:28rpx;">{{vod.vod_blurb}}</text>
						<view class="row" style="margin-top: 10rpx;">
							<text style="color:#707070;font-size:28rpx;">本月播放:{{vod.vod_hits_month}}</text>
							<text style="color:#707070;font-size:28rpx;padding:0 20rpx">总计播放:{{vod.vod_hits}}</text>
						</view>
					</view>
				</view>
				<view style="margin-top: 50rpx;padding:5rpx 20rpx;width: 700rpx;margin-left: 10rpx">
					<text v-if="data.state==0" style="color: #FFF;font-size: 32rpx;font-weight: 700;">购买整部短剧</text>
					<text v-if="data.state==1"
						style="color: #FFF;font-size: 32rpx;font-weight: 700;">购买第{{Number(data.index) + 1}}集</text>
				</view>
